...
void main() {
  group('Session Timeout Tests', () {
    test('v3.5 device handles session timeouts correctly', () async {
      ...
      try {
        ...
        expect(status1['success'], isTrue, reason: 'Initial status query should succeed');
        ...
        expect(turnOnResult['success'], isTrue, reason: 'Turn ON should succeed');
        ...
        expect(turnOffResult['success'], isTrue, reason: 'Turn OFF should succeed');
